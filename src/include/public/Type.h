...
enum class IPVersion : uint8_t {
    V4,
    V6,
    Auto, //By default, IPv4 is used. If the URL specifies IPv6, IPv6 will be used.
};

enum class HttpMethodType : uint8_t {
    Unknown = 0,
    Get = 1,
    Post = 2,
    Put = 3,
...
}; //end of enum class HttpStatusCode
